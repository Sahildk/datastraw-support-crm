...
import { LayoutDashboard, Ticket, RefreshCw, Activity } from 'lucide-react';

export default function Sidebar({ syncStatus, isSyncing }) {
  const isConnected = syncStatus.includes('Connected') || syncStatus.includes('Change');

  return (
    <aside className="w-64 bg-[#09090b] border-r border-zinc-800/80 flex flex-col justify-between h-screen sticky top-0 shrink-0">
      {/* Brand & Logo Area */}
      <div className="p-6">
